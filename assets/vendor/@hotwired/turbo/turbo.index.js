...
class O {
    ...
    async start() {
        ...
        if ('string' == typeof s) {
            if (!(await O.confirmMethod(s, this.formElement, this.submitter)))
                return;
        }
        if (this.state == e)
...
const Ee = {
    ...
    ye = new (class {
        ...
        willSubmitFormLinkToLocation(e, t) {
            return (
                this.elementIsNavigatable(e) && p(t, this.snapshot.rootLocation)
            );
        }
        ...
        allowsImmediateRender({ element: e }, t) {
            ...
            return (
                this.view.renderer &&
                    r &&
                    (this.view.renderer.renderElement = r),
                !i
            );
        }
...
(l.delegateConstructor = class {
    ...
    async extractForeignFrameElement(e) {
        ...
        try {
            if (
                ((t = Ve(e.querySelector(`turbo-frame#${s}`), this.sourceURL)),
                t)
            )
                return t;
            if (
    ...
    shouldInterceptNavigation(e, t) {
        ...
        return (
            !!ye.elementIsNavigatable(e) && !(t && !ye.elementIsNavigatable(t))
        );
    }
    get id() {
